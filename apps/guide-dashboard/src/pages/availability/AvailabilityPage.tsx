    ...
    useEffect(() => {
        ...
        setWorkingDays(
            availability.workingDays
                ? availability.workingDays.split(",")
                : []
        );
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div>
                ...
                <p className="mt-3 max-w-2xl leading-7 text-slate-500">
                    ...
                    availability and vacation mode.
                    Tourists can only book you
                    during your available days
                    and working hours.
                </p>
    ...
    <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-8 lg:col-span-2">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-slate-500">
                            Turn yourself online or
                            offline for bookings.
                        </p>
            ...
            <section className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-slate-500">
                            Hide yourself from new
                            bookings while you're
                            away.
                        </p>
            ...
            <section className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <p className="mt-2 text-slate-500">
                    Select the days when you
                    usually accept bookings.
                </p>
                ...
                <div className="space-y-8">
                    ...
                    <section className="rounded-[32px] border border-blue-200 bg-gradient-to-r from-blue-50 to-cyan-50 p-8">
                        ...
                        <ul className="mt-6 space-y-4 text-slate-600">
                            ...
                            <li>
                                • Turn Vacation Mode on when you're unavailable.
                            </li>

                            <li>
                                • More available days increase booking chances.
                            </li>

                            <li>
                                • Maintain consistent working hours for better visibility.
                            </li>
