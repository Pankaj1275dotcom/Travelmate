...
import usePendingHotels from "../../hooks/usePendingHotels";
import useApprovedHotels from "../../hooks/useApprovedHotels";
...
function HotelsPage() {
    ...
    return (
        <div className="space-y-8">
            <PageHeader
                title="Hotel Approvals"
                description="Review hotel registrations before approval."
            />
