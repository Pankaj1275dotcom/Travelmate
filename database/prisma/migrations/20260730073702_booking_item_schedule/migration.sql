-- AlterTable
ALTER TABLE `bookingitem` ADD COLUMN `driverEndDate` DATETIME(3) NULL,
...
-- CreateIndex
CREATE INDEX `BookingItem_guideStartDate_idx` ON `BookingItem`(`guideStartDate`);

-- CreateIndex
CREATE INDEX `BookingItem_driverStartDate_idx` ON `BookingItem`(`driverStartDate`);
